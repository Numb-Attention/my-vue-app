...
const init = {
    ...
    toolbar_mode: "none",
    plugins:
        'wordcount visualchars visualblocks  searchreplace save quickbars preview pagebreak nonbreaking media  insertdatetime importcss image help fullscreen directionality codesample code charmap link code table lists advlist anchor autolink autoresize ',
    toolbar:
    ...
    setup: (editor) => {
        editor.ui.registry.addButton('imageUpload', {
            ...
            onAction: () => {
                ...
                console.log(chooseImageRef.value);
...
watch(props, (newVal) => content.value = newVal.modelValue == null ? "" : newVal.modelValue)
//如果为空就不显示 否则 空数据会显示上一条的数据内容
