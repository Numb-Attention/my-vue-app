            ...
            <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
                ...
                <el-form-item label="升级条件">
                    <div>
                        ...
                        <el-input type="number" v-model="form.max_price" style="width: 50%;" placeholder="累计消费">
                    ...
                    <div>
                        ...
                        <el-input type="number" v-model="form.max_times" style="width: 50%;" placeholder="累计次数">
                ...
                <el-form-item label="折扣率(%)" prop="discount">
                    <el-input type="number" v-model="form.discount" style="width: 50%;" placeholder="等级权重">
                        <template #append>%</template>
                    </el-input>
                    <small class="text-gray-400 flex">
                        折扣率为单位百分，如输入90，表示该会员等级的用户可以以商品原价的百分之90购买
                    </small>
                </el-form-item>
            </el-form>
        </FormDrawer>
