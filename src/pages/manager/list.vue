<template>
  <el-card shadow="never" class="border-0">
    ...
    <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
      <el-table-column label="管理员" min-width="20%">
      ...
      <el-table-column label="所属管理员" min-width="20%" align="center">
        <template #default="{ row }">
          {{ row.role?.name || "-" }}
        </template>
      </el-table-column>
      ...
      <el-table-column prop="address" min-width="10%" label="操作" align="center">
        <template #default="scope">
          ...
          <div v-else>
            ...
            <el-popconfirm title="是否要删除该该管理员？" confirm-button-text="确认" cancel-button-text="取消"
    ...
    <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
      <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
        ...
        <el-form-item label="密码" prop="password">
          <el-input v-model="form.password" placeholder="公告内容"></el-input>
        </el-form-item>
